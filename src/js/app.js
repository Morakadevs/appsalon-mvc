...
function mostrarSeccion() {
    ...
    // Ocultar la seccióm que tenga la clase de mostrar
...
function seleccionarFecha() {
    ...
    inputFecha.addEventListener('input', function(e) {
        ...
        if( [0].includes(dia) ) {// Deshabilita los días, 6=Sabado, 0= Dominngo
            e.target.value = '';
...
function seleccionarHora() {
    ...
    inputHora.addEventListener('input', function(e) {
        ...
        if(hora < 8 || hora > 21) {
            e.target.value = ''; //Evita no guardar 
